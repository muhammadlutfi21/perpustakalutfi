...
<div class="card">
	...
	<div class="col-md-12">
			...
			<div class="row mb-3">
				...
				<div class="col-md-8">
					<select name="id_buku" class="form-control" >
						...
						<option <?php if($data['id_buku'] == $buku['id_buku']) echo 'selected'; ?> value="<?php echo 
						$buku['id_buku'];?>"><?php echo $buku['judul']; ?>
						</option>
						<?php  
							}
						 ?>
		...
		<div class="row mb-3">
				...
				<div class="col-md-8"><textarea name="ulasan" rows="5" class="form-control" required=""><?php echo $data['ulasan']; ?></textarea></div>
			</div>
