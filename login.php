...
<html lang="en">
    ...
    <body class="bg-info">
     <div class="main" style="background-image: url('./img/img.jpg')">
                                      ...
                                      $cek = mysqli_num_rows($data);
                                        ...
                                        <form method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputusername" type="username" name="username" placeholder="enter username">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <a class="btn btn-danger" href="register.php">Register</button></a>     
                                            </div>
                                        </form>
                                    </div>
                                    <section>
