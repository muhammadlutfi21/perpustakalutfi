		...
		<form class="form-group" action="" method="post">
			...
			if (isset($_POST["submit"])) {
				...
				$query = mysqli_query($koneksi, "UPDATE peminjaman set id_buku='$id_buku', 
					tanggal_peminjaman='$tanggal_peminjaman', tanggal_pengembalian='$tanggal_pengembalian', status_peminjaman='status_peminjaman' WHERE id_peminjam=$id ");
				if($query){
					echo "
					<script>
					alert('Ubah Peminjaman berhasil.');
