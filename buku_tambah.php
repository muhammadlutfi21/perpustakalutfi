		...
		<form class="form-group" action="" method="post">
			...
			if (isset($_POST["submit"])) {
				...
				$query = mysqli_query($koneksi, "INSERT INTO 
					buku(id_kategori,judul,penulis,penerbit,tahun_terbit,deskripsi)
				 values 
				 ('$id_kategori','$judul','$penulis','$penerbit','$tahun_terbit','$deskripsi')");
...
<div class="container">
		...
		<div class="row mb-3">
				...
				<div class="col-md-8"><textarea name="deskripsi" rows="4" class="form-control" required=""></textarea></div>
			</div>
